...
class DDNet_Waving(nn.Module):
    def __init__(self, frame_l, joint_n, joint_d, feat_d, filters, class_num):
        ...
        # diff_slow part (for slower motions)
        ...
        # after concatenation of slow and fast convs
        ...
        # Final layer for binary classification (waving vs non-waving)
